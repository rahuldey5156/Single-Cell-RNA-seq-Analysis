...
packageNames <- c("plotly", "Rtsne", "edgeR", "tximport", "org.Mm.eg.db", "gplots", "pheatmap", "tximport","limma","org.Mm.eg.db","gplots","edgeR","ggplot2","gridExtra","plotly","Rtsne","gridExtra","pkgconfig","RColorBrewer","Cairo","SingleCellExperiment","scater","scran","annotate")
...
gridExtra::grid.arrange(tSNEList1,tSNEList2,tSNEList3,tSNEList4,ncol=2)
